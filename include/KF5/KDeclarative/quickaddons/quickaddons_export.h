...
#  define QUICKADDONS_DECL_DEPRECATED __attribute__ ((__deprecated__))
#endif
...
#  define QUICKADDONS_DISABLE_DEPRECATED_BEFORE_AND_AT 0x55900
#endif
...
#  else
#    define QUICKADDONS_DEPRECATED_WARNINGS_SINCE 0x55900
#  endif
#endif
...
#  define QUICKADDONS_ENABLE_DEPRECATED_SINCE(major, minor) (ECM_GENERATEEXPORTHEADER_VERSION_VALUE(major, minor, 0) > QUICKADDONS_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#ifndef ECM_GENERATEEXPORTHEADER_QUICKADDONS_EXPORT_H
#define ECM_GENERATEEXPORTHEADER_QUICKADDONS_EXPORT_H
...
#endif /* ECM_GENERATEEXPORTHEADER_QUICKADDONS_EXPORT_H */
