...
#  define KCMUTILS_DISABLE_DEPRECATED_BEFORE_AND_AT 0x55900
#endif
...
#  else
#    define KCMUTILS_DEPRECATED_WARNINGS_SINCE 0x55900
#  endif
#endif
...
#if KCMUTILS_DEPRECATED_WARNINGS_SINCE >= 0x55700
#  define KCMUTILS_DEPRECATED_VERSION_5_87(text) KCMUTILS_DECL_DEPRECATED_TEXT(text)
#else
#  define KCMUTILS_DEPRECATED_VERSION_5_87(text)
#endif

#if KCMUTILS_DEPRECATED_WARNINGS_SINCE >= 0x55800
#  define KCMUTILS_DEPRECATED_VERSION_5_88(text) KCMUTILS_DECL_DEPRECATED_TEXT(text)
#else
#  define KCMUTILS_DEPRECATED_VERSION_5_88(text)
#endif
