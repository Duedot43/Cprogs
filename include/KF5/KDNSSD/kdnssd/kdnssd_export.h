...
#  define KDNSSD_DISABLE_DEPRECATED_BEFORE_AND_AT 0x55900
#endif
...
#  else
#    define KDNSSD_DEPRECATED_WARNINGS_SINCE 0x55900
#  endif
#endif
...
#define KDNSSD_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KDNSSD_DEPRECATED_VERSION_##major(minor, "Since "#textmajor"."#textminor". " text)
#if defined(__cpp_enumerator_attributes) && __cpp_enumerator_attributes >= 201411
#  define KDNSSD_ENUMERATOR_DEPRECATED_VERSION(major, minor, text) KDNSSD_DEPRECATED_VERSION(major, minor, text)
#  define KDNSSD_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KDNSSD_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#else
#  define KDNSSD_ENUMERATOR_DEPRECATED_VERSION(major, minor, text)
#  define KDNSSD_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#endif

#endif /* KDNSSD_EXPORT_H */


#ifndef ECM_GENERATEEXPORTHEADER_KDNSSD_EXPORT_H
#define ECM_GENERATEEXPORTHEADER_KDNSSD_EXPORT_H
...
#endif /* ECM_GENERATEEXPORTHEADER_KDNSSD_EXPORT_H */
