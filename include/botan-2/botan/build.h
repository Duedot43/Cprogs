...
* 'configure.py --prefix=/usr --with-bzip --with-lzma --with-zlib --with-boost --with-openssl --with-sqlite3 --with-os-feature=getrandom'
*
* Target
*  - Compiler: g++ -fstack-protector -m64 -pthread -std=c++11 -D_REENTRANT -march=x86-64 -mtune=generic -O2 -pipe -fno-plt
*  - Arch: x86_64
*  - OS: linux
*/
...
#define BOTAN_LIB_LINK "-lboost_system -lbz2 -lcrypto -ldl -llzma -lrt -lsqlite3 -lz"
...
#define BOTAN_HAS_OPENSSL 20151219
